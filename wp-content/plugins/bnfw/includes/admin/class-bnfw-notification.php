        ...
        <tr valign="top">
            ...
            <td>
                <select name="notification" id="notification" class="select2" data-placeholder="Select the notification type" style="width:75%">
                    ...
                    <option value="new-event" <?php selected( 'new-event', $setting['notification'] );?>><?php _e( 'New Event', 'bnfw' );?></option>
                    <option value="edit-event" <?php selected( 'edit-event', $setting['notification'] );?>><?php _e( 'Edit Event', 'bnfw' );?></option>
                    <option value="delete-event" <?php selected( 'delete-event', $setting['notification'] );?>><?php _e( 'Delete Event', 'bnfw' );?></option>
                    </optgroup>
